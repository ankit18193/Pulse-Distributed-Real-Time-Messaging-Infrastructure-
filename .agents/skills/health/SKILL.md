...
name: health
description: >-
  Codebase quality dashboard: Runs linters, type checkers, test suites, and dead code detectors to compute a composite 0-10 code health score. Use when asked to "code health", "health check", or "how healthy is the codebase".
---
...
After auto-detection, present the detected tools via ask_question:
