...
**ask_question Q2 — present the full proposal with SAFE/RISK breakdown:**
...
Each drill-down is one focused ask_question. After the user decides, re-check coherence with the rest of the system.
...
**ask_question Q-final — show summary and confirm:**
