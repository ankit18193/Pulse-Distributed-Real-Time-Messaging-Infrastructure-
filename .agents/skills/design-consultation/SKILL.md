...
description: >-
  Complete design system architecture: Interactively defines typography, colors, component tokens, layouts, and accessibility guidelines from scratch. Use when asked to "build a design system", "design consultation", or "create UI theme".
---
...
**ask_question Q1 — include ALL of these:**
...
the legacy approved.json aggregate — `~/.agents/skills/bin/gstack-taste-update`
...
> **STOP.** Before building the complete design-system proposal, drill-downs, the design preview, and writing DESIGN.md (Phases 3-6, after product context and research), Read `~/.agents/skills/design-consultation/sections/proposal-and-preview.md` and execute it
...
```bash
~/.agents/skills/bin/gstack-learnings-log '{"skill":"design-consultation","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
