...
name: design-review
description: >-
  Live-site visual and UI audit: Browser-based inspection of layout, spacing, contrast, micro-interactions, and visual polish with atomic fix commits. Use when asked to "design review", "audit ui", or "visual audit".
---
...
**If NO ecosystem marker matched:** Use ask_question:
...
$B url
```
If URL contains `/login`, `/signin`, `/auth`, or `/sso`: the site requires authentication. ask_question: "This site requires authentication. Want to import cookies from your browser? Run `/setup-browser-cookies` first if needed."
...
```bash
~/.agents/skills/bin/gstack-learnings-log '{"skill":"design-review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
