...
name: benchmark
description: >-
  Performance regression and load detection: Measures page load times, Core Web Vitals, payload sizes, and flags performance regressions. Use when asked to "benchmark", "check page speed", or "detect performance regression".
---
...
```bash
eval "$(~/.agents/skills/bin/gstack-slug 2>/dev/null || echo "SLUG=unknown")"
